...
const BlogInfo = ({
  ...
  return (
    <>
      <div className="w-[260px] h-[370px] drop-shadow border border-slate-200 shadow-slate-50 rounded-md overflow-hidden cursor-pointer transition-all hover:-translate-y-2 relative bg-white blog_box">
        <div
